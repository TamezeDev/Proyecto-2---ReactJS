...
const JoinForm = () => {
  ...
  return (
    <Flex
      ...
      padding={'20px'}
    >
      <Text fontSize="lg" color="green.700" fontWeight="bold" mb={8}>
      ...
      <Field.Root invalid={!!errors.email}>
        <Flex
          ...
          gap={3}
        >
          <Field.Label fontSize={{ base: 'sm', lg: 'md' }}>Email:</Field.Label>
          <Input
            variant="flushed"
            type="email"
            {...register('email', {
        ...
        >
          ...
          <Input
            ...
            {...register('age', {
              ...
              min: {
                value: 18,
                message: 'Debe ser mayor de edad para registrarse desde la web',
              },
              max: {
                value: 80,
                message:
      ...
      <Field.Root invalid={!!errors.img}>
        <Flex
          ...
          gap={3}
        >
          <Field.Label fontSize={{ base: 'sm', lg: 'md' }}>Imagen:</Field.Label>
          <Input
            alignContent={'center'}
            variant="subtle"
            type="file"
